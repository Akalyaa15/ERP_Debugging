...
class Clients_model extends Crud_model {
    ...
    function delete_client_and_sub_items($client_id) {
        ...
        $client_original = "SELECT id FROM $clients_tabless WHERE $clients_tabless.client_id= $client_id; ";
        $delete_client_sqls = "UPDATE $clients_tabless SET $clients_tabless.deleted=1 WHERE $clients_tabless.client_id=$client_id; ";
