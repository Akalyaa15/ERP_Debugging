<div id="page-content" class="clearfix p20">
    <div class="panel clearfix">
        ...
        <ul data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            ...
            <li><a role="presentation" class="active" href="javascript:;" data-target="#purchase_orders-tab"><?php echo lang("purchase_orders"); ?></a></li>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade" id="purchase_orders-tab">
    ...
    $(document).ready(function () {
        ...
        $("#purchase_order-table").appTable({
            ...
            columns: [
                ...
                {title: "<?php echo lang("purchase_order") ?>", "class": "w25p"},
                {visible: false, searchable: false},
                {visible: false, searchable: false},
                {title: "<?php echo lang("purchase_order_date") ?>", "iDataSort": 2},
                {visible: false, searchable: false},
                {title: "<?php echo lang("due_date") ?>", "class": "w10p", "iDataSort": 4},
                {title: "<?php echo lang("purchase_order_value") ?>", "class": "text-right"},
