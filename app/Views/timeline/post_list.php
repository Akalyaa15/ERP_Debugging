                        ...
                        <?php if ($this->login_user->is_admin || $post->created_by == $this->login_user->id) { ?>
                            <span class="pull-right mt-50 dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li role="presentation"><?php echo js_anchor("<i class='fa fa-times fa-fw'></i>".'Delete', array('title' => lang('delet'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("timeline/delete/$post->id"), "data-action" => "delete-confirmation")); ?> </li>
                                </ul>
                            </span>
                        <?php } ?>
