<!--           <?php if($this->login_user->is_admin) { ?> <div id="post-form-container">
...
<?php if($this->login_user->is_admin){ ?>
                 <button class="btn btn-default upload-file-button pull-left btn-sm round" type="button" style="color:#7988a2"><i class='fa fa-camera'></i> <?php echo lang("upload_file"); ?></button>
               <?php  } else { ?>
              <button class="btn btn-default upload-file-button pull-left btn-sm round" type="button" style="color:#7988a2;display: none;"><i class='fa fa-camera'></i> <?php echo lang("upload_file"); ?></button>
                <?php } ?>                <button class="submit-button btn btn-primary pull-right btn-sm" type="submit"><i class='fa fa-paper-plane'></i> <?php echo lang("post"); ?></button>
            </footer>
        </div>
        <?php echo form_close(); ?>
    </div>
