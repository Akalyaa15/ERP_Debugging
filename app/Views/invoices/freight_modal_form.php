...
<?php echo form_open(get_uri("invoices/save_freight"), array("id" => "freight-form", "class" => "general-form", "role" => "form")); ?>
...
<?php } ?>
    ...
    function applySelect2OnItemTitle() {
        $("#hsn_code").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("invoices/get_invoice_freight_suggestion"); ?>",
                dataType: 'json',
                quietMillis: 250,
            ...
            if (e.val === "+") {
               ...
               $('#hsn_description').val("").attr('readonly', false);
                ...
                $.ajax({
                    url: "<?php echo get_uri("invoices/get_invoice_freight_info_suggestion"); ?>",
