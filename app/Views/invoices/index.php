    ...
    loadInvoicesTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            ...
            columns: [
                ...
                {title: "<?php echo lang("expiry_date") ?>", "class": "w10p", "iDataSort": 5},
                {title: "<?php echo lang("invoice_value") ?>", "class": "w10p text-right"},
                 {title: "<?php echo lang("profit_value") ?>", "class": "w10p text-right"},
...
<?php echo $custom_field_headers; ?>,
            ...
            summation: [{column: 9, dataType: 'currency', currencySymbol: AppHelper.settings.currencySymbol}, {column: 10, dataType: 'currency', currencySymbol: AppHelper.settings.currencySymbol}, {column: 11, dataType: 'currency', currencySymbol: AppHelper.settings.currencySymbol},{column: 12, dataType: 'currency', currencySymbol: AppHelper.settings.currencySymbol}]
        });
