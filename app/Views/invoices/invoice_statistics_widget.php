<div class="panel panel-default">
    <div class="panel-heading">
        <i class="fa fa fa-file-text-o"></i>&nbsp; <?php echo anchor(get_uri("invoices"),lang("invoice_statistics")); /*echo lang("invoice_statistics");*/ ?>
    </div>
            ...
            var invoices =<?php echo $invoices; ?>,
                    ...
                    dataset = [
                        ...
                        },
                        {
                            ...
                            label: '<?php echo anchor(get_uri("invoices"),lang("invoice"),array("class" => "black-link")); ?>',
                            data: invoices,
                            color: "rgba(220,220,220, 1)",
                            lines: {
                                show: false
                        ...
                        },
                        {
                            ...
                            label:'<?php echo anchor(get_uri("invoice_payments"),lang("income"),array("class" => "black-link")); ?>',
                            data: payments,
                            color: "rgba(0, 179, 147, 1)",
                            lines: {
                                show: false
