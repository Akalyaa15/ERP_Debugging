<span style="font-size:20px; font-weight: bold;background-color: <?php echo $color; ?>; color: #fff;">&nbsp;<?php echo get_delivery_id($estimate_info->id); ?>&nbsp;</span>
...
?>
<span><?php echo lang("deliver_date") . ": " . format_to_date($estimate_info->delivered_date, false); ?></span><br />
