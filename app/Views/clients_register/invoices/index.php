...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#invoice-table").appTable({
            ...
            printColumns: combineCustomFieldsColumns([0, 2, 4, 6, 7, 8, 9,10, 11, 12], '<?php echo $custom_field_headers; ?>'),
            xlsColumns: combineCustomFieldsColumns([0, 2, 4, 6, 7, 8, 9,10, 11, 12], '<?php echo $custom_field_headers; ?>'),
            summation: [{column: 8, dataType: 'currency', currencySymbol: currencySymbol}, {column: 9, dataType: 'currency', currencySymbol: currencySymbol},{column: 10, dataType: 'currency', currencySymbol: currencySymbol},{column: 11, dataType: 'currency', currencySymbol: currencySymbol},{column: 12, dataType: 'currency', currencySymbol: currencySymbol}]
        });
    });
</script>