                    ...
                    <div class="form-group">
                        ...
                        <?php
                                echo form_checkbox(array(
                                    ...
                                    "name" => "share_with[]",
                                    "value" => "all_resource",
                                        ), $model_info->share_with, (in_array("all_resource", $share_with)) ? true : false);
                                ?>
                                <label for="share_with_clients"><?php echo lang("all_resource_members"); ?></label>
                            </div>
                            <div>
                            <?php
                                echo form_checkbox(array(
                                    ...
                                    "name" => "share_with[]",
                                    "value" => "all_partners",
                                        ), $model_info->share_with, (in_array("all_partners", $share_with)) ? true : false);
                                ?>
                            ...
                            <div>
                                ...
                                echo form_checkbox(array(
                                    ...
                                    "name" => "share_with[]",
                                    "value" => "all_vendors",
                                        ), $model_info->share_with, (in_array("all_vendors", $share_with)) ? true : false);
                                ?>
