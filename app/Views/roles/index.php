            ...
            <div class="row">
                <div class="col-md-4">
                    <div id="role-list-box" class="panel panel-default">
                        ...
                        <div class="table-responsiv b-t b-white" style="max-height: 450px;  overflow-y: scroll;">
                        <div class="pull-right">
                                <input type="text" id="search-messages" class="datatable-search" cellspacing="0" width="100%" placeholder="<?php echo lang('search') ?>">
                            </div>
...
var messagesTable = $('#role-table').DataTable();
