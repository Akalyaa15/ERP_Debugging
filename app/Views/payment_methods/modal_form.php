...
<div class="modal-body clearfix">
    ...
    <?php if ($model_info->type == "paypal_payments_standard" || $model_info->type == "stripe") { ?>
        <div class="form-group">
          ...
          <?php } ?>
        <?php if ($model_info->type == "net_banking") { ?>
        <div class="form-group">
            <label for="available_on_purchase_order" class="col-md-4"><?php echo lang('available_on_purchase_order'); ?>
                <span class="help" data-toggle="tooltip" title="<?php echo lang('available_on_purchase_order_help_text'); ?>"><i class="fa fa-question-circle"></i></span>
            </label>
            <div class="col-md-8">
                <?php
                echo form_checkbox("available_on_purchase_order", "1", $model_info->available_on_purchase_order, "id='available_on_purchase_order'");
                ?> 
            </div>
        </div>
        <?php } ?>
        <?php if ($model_info->type == "net_banking") { ?>
        <div class="form-group">
            <label for="available_on_work_order" class="col-md-4"><?php echo lang('available_on_work_order'); ?>
                <span class="help" data-toggle="tooltip" title="<?php echo lang('available_on_work_order_help_text'); ?>"><i class="fa fa-question-circle"></i></span>
            </label>
            <div class="col-md-8">
                <?php
                echo form_checkbox("available_on_work_order", "1", $model_info->available_on_work_order, "id='available_on_work_order'");
                ?> 
            </div>
        </div>
        <?php } ?>
