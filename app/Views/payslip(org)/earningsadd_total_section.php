<table id="payslip-earningsadd-table" class="table display dataTable text-right strong table-responsive">     
    ...
    <tr>
        <td><?php echo lang("total_earnings"); ?></td>
        <td style="width: 120px;"><?php echo to_currency($payslip_user_total_duration->earningsadd_subtotal, $earningsadd_total_summary->currency_symbol); ?></td>
        <td style="width: 100px;"></td>
    </tr>
    <tr>
    ...
    <tr>
        <td><?php echo lang("total"); ?></td>
        <td style="width: 120px;"><?php echo to_currency($payslip_user_total_duration->earningsadd_total, $earningsadd_total_summary->currency_symbol); ?></td>
        <td style="width: 100px;"> </td>
    </tr>
</table>