...
<?php if ($model_info->invoice_no) { ?>
        <div class=" form-group">
            <label for="invoice_date" class=" col-md-3"><?php echo lang('wo_no'); ?></label>
            <div class="col-md-9">
                <?php
 ...
 <?php } ?>  
    <?php if ($model_info->invoice_date) { ?>  
        ...
        <!--checklist-->
        <?php echo form_open(get_uri("clients_wo_list/save_checklist_item"), array("id" => "checklist_form", "class" => "general-form", "role" => "form")); ?>
...
<div id="link-of-task-view" class="hide">
           ...
           // echo modal_anchor(get_uri("attendance/todo_view"), "", array());
            echo modal_anchor(get_uri("clients_wo_list/task_view/"), "<i class='fa fa-pencil'></i> " . lang('edit'), array("class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => lang('add_todo')));
    ...
    echo modal_anchor(get_uri("clients_wo_list/modal_form/"), "<i class='fa fa-pencil'></i> " . lang('edit_client_wo_list'), array("class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => lang('edit_client_wo_list')));
...
var uploadUrl = "<?php echo get_uri("clients_wo_list/upload_file"); ?>";
        ...
        Sortable.create($selector[0], {
            ...
            onUpdate: function (e) {
                ...
                //update sort indexes
                $.ajax({
                    url: '<?php echo_uri("clients_wo_list/save_checklist_items_sort") ?>',
                    type: "POST",
 ...
 $("#checklist_form .select2").select2();
        ...
        $("#checklist_form").appForm({
            ...
            onSuccess: function (response) {
                ...
                $.ajax({
                    url: "<?php echo get_uri("clients_wo_list/get_vendors_invoice_paid_suggestion"); ?>",
      ...
      if(total_paid){
       ...
       $("#client_due").val(total_due_amount);
        ...
        $('body').on('click', '[data-act=update-checklist-item-status-checkbox]', function () {
            ...
            $.ajax({
                url: '<?php echo_uri("clients_wo_list/save_checklist_item_status") ?>/' + $(this).attr('data-id'),
                type: 'POST',
                dataType: 'json',
