<div id="page-content" class="clearfix p20">
    <div class="panel clearfix">
        <ul data-toggle="ajax-tab" class="nav nav-tabs bg-white inner" role="tablist">
            <li class="title-tab"><h4 class="pl15 pt5 pr15"><?php echo lang("work_order_payments"); ?></h4></li>
            ...
            <li><a role="presentation" href="<?php echo_uri("work_order_payments/yearly/"); ?>" data-target="#yearly-payments"><?php echo lang('yearly'); ?></a></li>
            <li><a role="presentation" href="<?php echo_uri("work_order_payments/custom/"); ?>" data-target="#custom-payments"><?php echo lang('custom'); ?></a></li>
            <li><a role="presentation" href="<?php echo_uri("work_order_payments/yearly_chart/"); ?>" data-target="#yearly-chart"><?php echo lang('chart'); ?></a></li>
        </ul>

        <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade" id="monthly-payments">
                <div class="table-responsive">
                    <table id="monthly-work_order-payment-table" class="display" width="100%">
                    </table>
                </div>
            </div>
        ...
        <div role="tabpanel" class="tab-pane fade" id="team_member-monthly-leaves">
            ...
            <script type="text/javascript">
                loadPaymentsTable = function (selector, dateRange) {
                    ...
                    $(selector).appTable({
                        source: '<?php echo_uri("work_order_payments/payment_list_data/") ?>',
                        order: [[0, "asc"]],
                ...
                $(document).ready(function () {
                    ...
                    loadPaymentsTable("#monthly-work_order-payment-table", "monthly");
                });
            </script>
        </div>
