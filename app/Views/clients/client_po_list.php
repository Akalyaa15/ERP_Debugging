<?php if (isset($page_type) && $page_type === "full") { ?>
    ...
    <div class="panel">
        <?php if (isset($page_type) && $page_type === "full") { ?>
            <div class="page-title clearfix">
                ...
                <div class="title-button-group">
                    <?php
                echo modal_anchor(get_uri("clients_po_list/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_client_po'), array("class" => "btn btn-default mb0", "data-post-client_id" => $client_id,"title" => lang('add_client_po'))); ?>
                </div>
            </div>
        <?php } else { ?>
        ...
        <div class="table-responsive">
            <table id="monthly-clients_po_list-table" class="display" width="100%">
            </table>
        </div>
    </div>
    <?php if (isset($page_type) && $page_type === "full") { ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#monthly-clients_po_list-table").appTable({
