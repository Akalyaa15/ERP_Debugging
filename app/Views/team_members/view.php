...
<div id="page-content" class="clearfix">
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs" role="tablist">
        ...
        <?php } ?>
         <?php if ($show_general_info) { ?>
            <li><a  role="presentation" href="<?php echo_uri("team_members/kyc_info/" . $user_info->id); ?>" data-target="#tab-kyc-info"> <?php echo lang('kyc_info'); ?></a></li>
        <?php } ?>

        <?php if ($show_bank_statement) { ?>
           <li><a  role="presentation" href="<?php echo_uri("team_members/bank_statement_info/" . $user_info->id); ?>" data-target="#tab-bank_statement-info"> <?php echo lang('bank_statement'); ?></a></li>
        <?php } ?> 
        
        <?php if ($show_payslip) { ?>
            <li><a role="presentation" href="<?php echo_uri("team_members/payslip_info/" . $user_info->id); ?>" data-target="#tab-payslip-info"><?php echo lang('payslip'); ?></a></li>
        <?php } ?> 
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab-bank_statement-info"></div>
        <div role="tabpanel" class="tab-pane fade" id="tab-payslip-info"></div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        }else if (tab === "bank_statement") {
            $("[data-target=#tab-bank_statement-info]").trigger("click");
