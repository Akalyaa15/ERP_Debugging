<div id="page-content" class="p20 clearfix">
    <div class="row">
        <div class="col-sm-3 col-lg-2">
            <?php
            $tab_view['active_tab'] = "terms_conditions_templates";
                ...
                <div class="col-md-3">
                    <div id="template-list-box" class="panel panel-default">
                        <div class="page-title clearfix">
                            <h4> <?php echo lang('terms_conditions_templates'); ?></h4>
                        </div>
                ...
                <div class="col-md-9">     
                   <div class="page-title clearfix">
                    <div class="title-button-group">
                        <?php echo modal_anchor(get_uri("terms_conditions_templates/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_terms_conditions_template'), array("class" => "btn btn-default", "title" => lang('add_terms_conditions_template'))); ?>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#email-template-table").appTable({
            source: '<?php echo_uri("terms_conditions_templates/list_data") ?>',
            order: [],
            columns: [
        ...
        $("body").on("click", "tr", function () {
            ...
            if (!$(this).hasClass("active")) {
                ...
                if (template_name) {
                    ...
                    $.ajax({
                        url: "<?php echo get_uri("terms_conditions_templates/form"); ?>/" + template_name,
