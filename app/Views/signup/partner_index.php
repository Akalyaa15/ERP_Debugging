                ...
                <div class="signin-box">
                    <div class="panel panel-default clearfix">
                        <div class="panel-heading text-center">
                            ...
                            <p><?php echo $signup_message_partner; ?></p>
                        </div>
                         <input type="hidden" name="ids" value="partners" />
                        <div class="panel-body">
<?php echo form_open("signup_partner/create_account", array("id" => "signup-form", "class" => "general-form", "role" => "form")); ?>
...
<?php if ($signup_type === "new_client") { ?>
                            ...
                            <?php } ?>
<?php if ($signup_type_partner === "new_partner") { ?>
                                <div class="form-group">
                                    <label for="company_name" class=" col-md-12"><?php echo lang('company_name'); ?></label>
                                    <div class=" col-md-12">
                                        <?php
...
<?php if ($type === "staff"||$type === "resource") { ?>
                                <div class="form-group">
