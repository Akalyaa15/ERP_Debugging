<?php echo form_open(get_uri("vap_category/save"), array("id" => "vap_category-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#vap_category-form").appForm({
            onSuccess: function(result) {
                $("#vap_category-table").appTable({newData: result.data, dataId: result.id});
            }
        });
        $("#title").focus();
    });
