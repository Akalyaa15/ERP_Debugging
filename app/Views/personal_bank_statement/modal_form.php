<?php echo form_open(get_uri("personal_bank_statement/save"), array("id" => "remark-form", "class" => "general-form", "role" => "form")); ?>
...
onSuccess: function(result) {
                ...
                $("#expense-table").appTable({newData: result.data, dataId: result.id});
            }
        });
        $("#remark").focus();
    });
