<div class="tab-content">
    ...
    if (isset($user_type) && $user_type === "resource") {
        $reload_url = get_uri("rm_members/view/" . $user_id . "/social");
    $save_url = get_uri("rm_members/save_social_links/" . $user_id);
    }
    if (isset($user_type) && $user_type === "client") {
        $reload_url = "";
        $save_url = get_uri("clients_register/save_contact_social_links/" . $user_id);
    }
    if (isset($user_type) && $user_type === "vendor") {
        $reload_url = "";
        $save_url = get_uri("vendors_register/save_contact_social_links/" . $user_id);
    }
    if (isset($user_type) && $user_type === "company") {
        $reload_url = "";
        $save_url = get_uri("companys/save_contact_social_links/" . $user_id);
    }
