<?php echo form_open(get_uri("mode_of_dispatch/save"), array("id" => "mode_of_dispatch-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#mode_of_dispatch-form").appForm({
            onSuccess: function(result) {
                $("#mode_of_dispatch-table").appTable({newData: result.data, dataId: result.id});
            }
        });
        $("#title").focus();
    });
