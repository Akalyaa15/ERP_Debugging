<div class="tab-content">
    <?php echo form_open(get_uri("rm_members/save_general_info/" . $user_info->id), array("id" => "general-info-form", "class" => "general-form dashed-row white", "role" => "form")); ?>
    <div class="panel">
    ...
    $(document).ready(function () {
        $("#general-info-form").appForm({
            ...
            onSuccess: function (result) {
                ...
                setTimeout(function () {
                    window.location.href = "<?php echo get_uri("rm_members/view/" . $user_info->id); ?>" + "/general";
                }, 500);
            }
        });
