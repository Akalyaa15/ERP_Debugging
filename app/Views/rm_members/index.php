<div id="page-content" class="p20 clearfix">
    ...
    <div class="page-title clearfix">
            <h1><?php echo lang('rm_members'); ?></h1>
            <div class="title-button-group">
                <div class="btn-group" role="group">
                    ...
                    <?php echo anchor(get_uri("rm_members/view"), "<i class='fa fa-th-large'></i>", array("class" => "btn btn-default btn-sm")); ?>
                </div>
                <?php
                if ($this->login_user->is_admin) {
                    echo modal_anchor(get_uri("rm_members/invitation_modal"), "<i class='fa fa-envelope-o'></i> " . lang('send_invitation'), array("class" => "btn btn-default", "title" => lang('send_invitation')));
                    echo modal_anchor(get_uri("rm_members/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_team_member'), array("class" => "btn btn-default", "title" => lang('add_team_member')));
                }
                ?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#team_member-table").appTable({
            source: '<?php echo_uri("rm_members/list_data/") ?>',
            order: [[1, "asc"]],
            ...
            columns: [
                ...
                {visible: visibleContact, title: "<?php echo lang("alternative_phone") ?>", "class": "w15p"}
