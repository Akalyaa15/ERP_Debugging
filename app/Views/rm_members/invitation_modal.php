<?php echo form_open(get_uri("rm_members/send_invitation"), array("id" => "invitation-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <br />
    <div class="form-group mb15">
        <label for="email" class=" col-md-12"><?php echo lang('invite_someone_to_join_as_a_outsource_member'); ?></label>
        <div class="col-md-12">
