    ...
    $(document).ready(function () {
        ...
        $("#ticket-table").appTable({
            ...
            //radioButtons: [{text: '<?php /*echo lang("open") ?>', name: "status", value: "open", isChecked: true}, {text: '<?php echo lang("closed") */?>', name: "status", value: "closed", isChecked: false}],
             radioButtons: [ <?php if($ticket_new=="open"){ ?>{text: '<?php echo lang("new") ?>', name: "status", value: "new", isChecked: false},{text: '<?php echo lang("open") ?>', name: "status", value: "open", isChecked: true}, {text: '<?php echo lang("closed") ?>', name: "status", value: "closed", isChecked: false}<?php }else if($ticket_new=="closed"){ ?>{text: '<?php echo lang("new") ?>', name: "status", value: "new", isChecked: false},{text: '<?php echo lang("open") ?>', name: "status", value: "open", isChecked: false}, {text: '<?php echo lang("closed") ?>', name: "status", value: "closed", isChecked: true}<?php }else{ ?>{text: '<?php echo lang("new") ?>', name: "status", value: "new", isChecked: true},{text: '<?php echo lang("open") ?>', name: "status", value: "open", isChecked: false}, {text: '<?php echo lang("closed") ?>', name: "status", value: "closed", isChecked: false}<?php } ?>],
