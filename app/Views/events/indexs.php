...
<div id="page-content<?php echo $vendor; ?>" class="p20<?php echo $vendor; ?> clearfix">
        ...
        <div class="page-title clearfix">
         ...
         <?php } ?>
            <div class="title-button-group">
                 <?php echo modal_anchor(get_uri("events/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_event'), array("class" => "btn btn-default", "title" => lang('add_event'),"data-post-vendor_id" => $vendor)); ?>
               
        
               
                <?php echo modal_anchor(get_uri("events/modal_form"), "", array("class" => "hide", "id" => "add_event_hidden", "title" => lang('add_event'), "data-post-vendor_id" => $vendor)); ?>
                
                <?php echo modal_anchor(get_uri("events/view"), "", array("class" => "hide", "id" => "show_event_hidden", "data-post-vendor_id" => $vendor, "data-post-cycle" => "0", "data-post-editable" => "1", "title" => lang('event_details'))); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#event-calendar").fullCalendar({
            ...
            events: "<?php echo_uri("events/calendar_eventss/" .
           $vendor); ?>",
             //events: "<?php echo_uri("events/vendor_calendar_events/" .
            $vendor); ?>",
