...
<script type="text/javascript">
    loadVendorsInvoiceListTable = function (selector, dateRange) {
       ...
       $(selector).appTable({
           ...
           //summation: [{column: 4, dataType: 'currency'},{column: 5, dataType: 'currency'},{column: 6, dataType: 'currency'},{column: 7, dataType: 'currency'},{column: 8, dataType: 'currency'},{column: 9, dataType: 'currency'},{column: 10, dataType: 'currency'}]
