 ...
 <?php } ?>  
    <?php if ($model_info->invoice_date) { ?>  
        ...
        */?>
        ...
        <div class="form-group">
                    <label for="reference_number" class=" col-md-3"><span id="ref_name"></span></label>
            <div class="col-md-9">
                        <?php
                        echo form_input(array(
                            "id" => "reference_number",
...
<div id="link-of-task-view" class="hide">
           ...
           // echo modal_anchor(get_uri("attendance/todo_view"), "", array());
            echo modal_anchor(get_uri("vendors_invoice_list/task_view/"), "<i class='fa fa-pencil'></i> " . lang('edit'), array("class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => lang('add_todo')));
...
<!--script type="text/javascript">
$("#checklist-options-panels").on('click', function (){
         $("#remove").click();
