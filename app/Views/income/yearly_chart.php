...
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            ...
            <div id="income-chart-date-range-selector">
    ...
    <div class="panel-body ">
        <div style="padding-left:35px;">
            <div id="yearly-income-chart" style="width:100%; height: 350px;"></div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    var prepareExpensesFlotChart = function (data) {
        appLoader.show();
        $.ajax({
            url: "<?php echo_uri("income/yearly_chart_data") ?>",
            data: data,
            cache: false,
            type: 'POST',
            dataType: "json",
    ...
    $(document).ready(function () {
        $("#income-chart-date-range-selector").appDateRange({
