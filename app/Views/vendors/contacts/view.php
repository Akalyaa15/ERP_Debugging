...
<div id="page-content" class="clearfix">
    <div class="row bg-dark-success p20">
        ...
        <div class="col-md-6">
            <p> 
                <?php
                $client_link = anchor(get_uri("vendors/view/" . $vendor_info->id), $vendor_info->company_name, array("class" => "white-link"));

                if ($this->login_user->user_type === "vendor") {
                    $client_link = anchor(get_uri("vendors/contact_profile/" . $this->login_user->id . "/company"), $vendor_info->company_name, array("class" => "white-link"));
                }
...
$options = array(
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs" role="tablist">
        <li><a  role="presentation" href="<?php echo_uri("vendors/contact_general_info_tab/" . $user_info->id); ?>" data-target="#tab-general-info"> <?php echo lang('general_info'); ?></a></li>
        <?php if($show_company_info){ ?>
        <li><a  role="presentation" href="<?php echo_uri("vendors/company_info_tab/" . $user_info->vendor_id); ?>" data-target="#tab-company-info"> <?php echo lang('company'); ?></a></li>
        <?php } ?>
        <li><a  role="presentation" href="<?php echo_uri("vendors/bank_info_tab/" . $user_info->vendor_id); ?>" data-target="#tab-bank-info"> <?php echo lang('company_kyc'); ?></a></li>
        <li><a  role="presentation" href="<?php echo_uri("vendors/contact_social_links_tab/" . $user_info->id); ?>" data-target="#tab-social-links"> <?php echo lang('social_links'); ?></a></li>
        <li><a role="presentation" href="<?php echo_uri("vendors/account_settings/" . $user_info->id); ?>" data-target="#tab-account-settings"> <?php echo lang('account_settings'); ?></a></li>
        <?php if ($user_info->id == $this->login_user->id) { ?>
            <li><a role="presentation" href="<?php echo_uri("vendors/my_preferences/" . $user_info->id); ?>" data-target="#tab-my-preferences"> <?php echo lang('my_preferences'); ?></a></li>
        <?php } ?>
         <?php if ($user_info->id == $this->login_user->id && !get_setting("disable_editing_left_menu_by_vendors")) { ?>
        ...
        <?php } ?>
             ...
             <li><a  role="presentation" href="<?php echo_uri("vendors/contact_kyc_info_tab/" . $user_info->id); ?>" data-target="#tab-kyc-info"> <?php echo lang('kyc_info'); ?></a></li>
