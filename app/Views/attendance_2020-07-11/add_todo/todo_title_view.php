...
<div class="modal-footer">
    <?php
    echo modal_anchor(get_uri("attendance/add_todo_modal_form/"), "<i class='fa fa-pencil'></i> " . lang('edit'), array("class" => "btn btn-default", "data-post-id" => $model_info->id, "title" => lang('edit')));
    ?>
