<?php echo form_open(get_uri("partners_register/save"), array("id" => "partners-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <?php $this->load->view("partners_register/client_form_fields"); ?>
</div>
