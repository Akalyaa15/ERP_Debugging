...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#invoice-table").appTable({
            ...
            printColumns: combineCustomFieldsColumns([0, 4, 5, 6, 7, 8, 9,10], '<?php echo $custom_field_headers; ?>'),
            xlsColumns: combineCustomFieldsColumns([0, 4, 5, 6, 7, 8, 9,10], '<?php echo $custom_field_headers; ?>'),
