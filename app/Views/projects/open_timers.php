<?php if ($timers) { ?>
    <li class="">
        <?php echo js_anchor("&nbsp;", array("id" => "project-timer-icon", "class" => "dropdown-toggle animated-clock", "data-toggle" => "dropdown","title" => lang('project_timer'))); ?>
                ...
                <div class="list-group">
                    <?php foreach ($timers as $timer) { ?>
                        <div  class="list-group-item"> 
                            <div class="clearfix">
                                <span class="pull-left mt5" title=" <?php echo attendance_format_to_datetime($timer->start_time); ?>">
                                    <?php
                                    //echo lang("started_at") . " <strong>" . format_to_time($timer->start_time) . "</strong>";
                                    echo lang("started_at") . " <strong>" . attendance_format_to_time($timer->start_time) . "</strong>";
                                    ?>
                                </span>
