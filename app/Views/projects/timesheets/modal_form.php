...
<div class="modal-body clearfix">
    ...
    <div class="clearfix">
        ...
        <?php if ($show_porject_members_dropdown) { ?>
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <?php
                    echo form_dropdown("user_id", $project_members_dropdown, array($model_info->user_id), "class='select2'");
                    ?>
                </div>
            </div>
            <?php
        ...
        <div class="col-md-4 col-sm-4 form-group">
            ...
            $in_time = is_date_exists($model_info->start_time) ? $model_info->start_time : "";
    ...
    <div class="clearfix">
        ...
        <div class=" col-md-4 col-sm-4 form-group">
            ...
            $out_time = is_date_exists($model_info->end_time) ? $model_info->end_time : "";
