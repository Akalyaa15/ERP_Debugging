<?php
//task status widget get url
    //$link = $_SERVER['PHP_SELF'];
    $link =get_uri(uri_string());
...
$default_view =get_uri("projects/view/" . $project_info->id);
$cururl_view = get_uri(uri_string());
//echo $default_view;
//echo $cururl_view;
if($default_view === $cururl_view){
    
    $task_status_id= 0; 
}else if(get_uri("projects/view/$project_info->id/tasks/$project_info->id/$page")== $cururl_view){
   $task_status_id = $page;
}else{
     $task_status_id = 0;
}
        ...
        <div class="col-md-12">
            <div class="page-title clearfix">
                <h1>
                    ...
                    if($project_info->clone_project_id && $project_info->clone_project_id !=0 ){ 
                    $ref_project = $this->Projects_model->get_one($project_info->clone_project_id); 
                    echo "(Clone From -".anchor(get_uri("projects/view/" . $project_info->clone_project_id), $ref_project->title).")"; 
                }
            }?> 
            ...
            <ul id="project-tabs" data-toggle="ajax-tab" class="nav nav-tabs classic" role="tablist">
                <?php if ($this->login_user->user_type === "staff"||$this->login_user->user_type === "resource") { ?>
                   ...
                   <!--  <li><a role="presentation" href="<?php /* echo_uri("projects/tasks/" . $project_info->id); ?>" data-target="#project-tasks-section"><?php echo lang('tasks')." ".lang("list"); */?></a></li> -->
                    <li><a role="presentation" href="<?php echo_uri("projects/tasks/$project_info->id/$task_status_id"); ?>" data-target="#project-tasks-section"><?php echo lang('tasks')." ".lang("list"); ?></a></li>
                    ...
                    <?php if($this->login_user->is_admin){ ?>
                        <li><a role="presentation" href="<?php echo_uri("projects/timesheets_ot/" . $project_info->id); ?>" data-target="#project-timesheets_ot-section"> <?php echo lang('timesheets_ot'); ?></a></li>
                    <?php } ?>
                ...
                <?php } else { ?>
                    ...
                    <?php if ($show_tasks) { ?>
                       <!--  <li><a role="presentation" href="<?php /* echo_uri("projects/tasks/" . $project_info->id); ?>" data-target="#project-tasks-section"><?php echo lang('task')." ".lang("list");*/  ?></a></li> -->
                        <li><a role="presentation" href="<?php echo_uri("projects/tasks/$project_info->id/$task_status_id"); ?>" data-target="#project-tasks-section"><?php echo lang('task')." ".lang("list"); ?></a></li>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade" id="project-timesheets_ot-section"></div>
