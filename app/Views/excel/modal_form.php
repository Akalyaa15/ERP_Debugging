<?php echo form_open(get_uri("excel_import/save"), array("id" => "remark-form", "class" => "general-form", "role" => "form")); ?>
...
onSuccess: function(result) {
                ...
                $("#import_excel-table").appTable({newData: result.data, dataId: result.id});
            }
        });
        $("#remark").focus();
    });
