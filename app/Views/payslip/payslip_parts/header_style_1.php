...
if($user_branch_code){ 
    ...
    $get_company_name = $this->Companys_model->get_details(array("cr_id"=>$get_user_branch_info->company_name))->row();
}
?>
...
$company_name = $get_company_name->company_name ? $get_company_name->company_name : "-";
?>
...
<table style="color: #444; width: 100%;">
    ...
    <table style="color: #444; width: 100%;">
    <tr>
        <td><div style="font-weight: bold;color:black;"><strong><?php echo $company_name; ?></strong></div>
...
<table style="color: #444; width: 100%;font-size: 82%;border: 1px solid #666;">
    <tr>
        <td><?php
