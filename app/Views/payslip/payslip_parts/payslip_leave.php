...
$payable_days = $payslip_user_total_duration->total_payable_days_inmonth? $payslip_user_total_duration->total_payable_days_inmonth:"0";
...
$present_days = $payslip_user_total_duration->total_user_days ? $payslip_user_total_duration->total_user_days : "0";
...
$annual_leave_eligible = $payslip_user_total_duration->monthly_eligible_leave_from_joining?$payslip_user_total_duration->monthly_eligible_leave_from_joining:0;
...
<table style="color: #444; width: 100%;">
   ...
   <tr> <td style="width: 70%; font-weight: bold;color:black;"><?php  echo "LOP Days Based On Hours"; ?> </td> <td style="width: 30%;"><?php echo ": " . ($lop_days);?></td></tr>
    <tr><td style="width: 70%; font-weight: bold;color:black;"><?php  echo "Annual Leave Eligible Days"; ?> </td> <td style="width: 30%;"><?php echo ": " . ($annual_leave_eligible);?></td></tr>
    <tr><td style="width: 70%; font-weight: bold;color:black;"><?php  echo "Annual Leave Taken Days"; ?> </td> <td style="width: 30%;"><?php echo ": " . ($annual_leave_taken);?></td></tr>
     <tr><td style="width: 70%; font-weight: bold;color:black;"><?php  echo "Annual Leave Available Days"; ?> </td> <td style="width: 30%;"><?php echo ": " . ($annaul_leave_available);?></td></tr>
