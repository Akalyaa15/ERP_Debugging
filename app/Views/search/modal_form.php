...
<?php echo modal_anchor(get_uri("projects/task_view"), "", array("title" => lang('task_info') . "", "data-post-id" => "", "class" => "hide","id" => "show_task_hidden")); ?>
    ...
    $(document).ready(function () {
        ...
        $searchBox.on('awesomplete-selectcomplete', function () {
            ...
            if (this.value) {
                ...
                }else if (searchFieldValue === "task") {
                        /*location = "<?php echo get_uri("projects/view"); ?>/" + this.value;*/
                    $("#show_task_hidden").attr("data-post-id", this.value);
                    $("#show_task_hidden").trigger("click");
                        
                    } else {
                    if (searchFieldValue === "project") {
                        location = "<?php echo get_uri("projects/view"); ?>/" + this.value;
                    } else if (searchFieldValue === "client") {
                        location = "<?php echo get_uri("clients/view"); ?>/" + this.value;
                    }else if (searchFieldValue === "vendor") {
                        location = "<?php echo get_uri("vendors/view"); ?>/" + this.value;
                    }else if (searchFieldValue === "company") {
                        location = "<?php echo get_uri("companys/view"); ?>/" + this.value;
                    }
