<div id="page-content" class="p20 clearfix">
    <div class="panel panel-default">
        ...
        <ul data-toggle="ajax-tab" class="nav nav-tabs bg-white inner" role="tablist">
            ...
            <li><a  role="presentation" href="<?php echo_uri("leaves/summary_details/"); ?>" data-target="#leave-summary-details"><?php echo lang("summary_details"); ?></a></li>
        </ul>
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade" id="leave-summary-details"></div>
        </div>
    </div>
</div>