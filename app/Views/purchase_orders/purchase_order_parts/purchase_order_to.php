...
$optionss = array(
            "id" =>$purchase_order_info->dispatched_through,
                   );
...
<?php } ?>
  ...
  text-align: left;padding: 5px;height: 30px;"><?php echo lang("buyer_purchase_order_no").":";?><?php if ($purchase_order_info->purchase_order_no) { ?>
            <div style="font-weight: bold;color:#232323;"><?php echo $purchase_order_info->purchase_order_no; ?></div>
            <?php } ?></td>
    <td style="border: 1px solid #dddddd;color: #666;font-size:14px;
  text-align: left;padding: 5px;height: 30px"><?php echo lang("buyer_purchase_order_date") . ": " ;?><?php if ($purchase_order_info->purchase_date) { ?><div style="font-weight: bold;color:#232323;"><?php if($purchase_order_info->purchase_order_no){ echo format_to_date($purchase_order_info->purchase_date, false); } ?><?php } ?></div></td>
    
  </tr>
  <tr style="border: 1px solid #dddddd;
  text-align: left;padding: 5px;">
  <td style="border: 1px solid #dddddd;color: #666;font-size:14px;
  text-align: left;padding: 5px;height: 30px;"><?php echo lang("delivery_note").":";?><?php if ($purchase_order_info->note) { ?>
                <div style="font-weight: bold;color:#232323;"><?php echo $purchase_order_info->note; ?></div>
            <?php } ?></td>
    <td style="border: 1px solid #dddddd;color: #666;font-size:15px;
  text-align: left;padding: 5px;height: 30px;"><?php echo lang("delivery_note_date").":";?> <?php if ($purchase_order_info->delivery_note_date) { ?><div style="font-weight: bold;color:#232323;"><?php if($purchase_order_info->note){ echo format_to_date($purchase_order_info->delivery_note_date, false); } ?></div><?php } ?></td>
  ...
  text-align: left;padding: 5px;">
<td style="border: 1px solid #dddddd;color: #666;font-size:14px;
  text-align: left;padding: 5px;height: 40px"><?php echo lang("dispatch_docket").":" ;?><?php if ($purchase_order_info->dispatch_document_no) { ?><div style="font-weight: bold;color:#232323;"><?php echo $purchase_order_info->dispatch_document_no; ?></div>
            <?php } ?></td>
            <td   style="border: 1px solid #dddddd;color: #666;font-size:15px;
  text-align: left;padding: 5px;height:40px;"><?php echo lang("dispatched_through").":";?><?php if ($purchase_order_info->dispatched_through) { ?>
  ...
  text-align: left;padding: 5px;height: 20px;font-weight: bold;"><?php if ($purchase_order_info->destination) { ?>
               <b><?php echo($purchase_order_info->destination); ?></b>
            <?php } ?></td>
  ...
  text-align: left;padding: 5px;">
    ...
    <td  colspan="2"; style="border: 1px solid #dddddd;color: #666;font-size:14px;
  text-align: left;padding: 5px;height:60px;"><?php echo lang("terms_of_delivery").":";?><?php if ($purchase_order_info->terms_of_delivery) { ?>
               <div style="font-weight: bold;color:#232323;"><?php echo $purchase_order_info->terms_of_delivery; ?></div>
            <?php } ?></td>
