...
<?php echo form_open(get_uri("purchase_orders/save_freight"), array("id" => "freight-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <input type="hidden" name="purchase_order_id" value="<?php echo $model_info->id; ?>" />
    ...
    $(document).ready(function () {
        $("#freight-form").appForm({
            onSuccess: function (result) {
                ...
                if (result.success && result.purchase_order_total_view) {
...
$('#hsn_code').attr('readonly', true);
    ...
    function applySelect2OnItemTitle() {
        $("#hsn_code").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("purchase_orders/get_invoice_freight_suggestion"); ?>",
                dataType: 'json',
                quietMillis: 250,
            ...
            if (e.val === "+") {
               ...
               $('#hsn_description').val("").attr('readonly', false);
                ...
                $.ajax({
                    url: "<?php echo get_uri("purchase_orders/get_invoice_freight_info_suggestion"); ?>",
