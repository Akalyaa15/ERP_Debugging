...
$DB4->select ("discount_percentage");
 $DB4->from('purchase_order_items');
 $DB4->where('purchase_order_items.purchase_order_id',$purchase_order_info->id);
  $DB4->where('purchase_order_items.discount_percentage!=','0');
 $DB4->where('purchase_order_items.deleted','0');
...
<table style="width: 100%; color: #444;">            
    ...
    <th style="width: 7%; text-align: center; border-right: 1px solid #eee;"> <?php echo lang("s.no"); ?> </th>
        <th style="width: 18%; border-right: 1px solid #eee;"> <?php echo lang("model"); ?> </th>
        <th style="text-align: left;  width: 12%; border-right: 1px solid #eee;"> <?php echo lang("category"); ?></th>
        <th style="text-align: center;  width: 14%; border-right: 1px solid #eee;"> <?php echo lang("make"); ?></th>
    <th style="text-align: center;  width: 6%; border-right: 1px solid #eee;"> <?php echo lang("hsn_code"); ?></th>
    <th style="text-align: center;  width: 7%; border-right: 1px solid #eee;"> <?php echo lang("gst"); ?></th>
 <th style="text-align: center;  width: 8%; border-right: 1px solid #eee;font-size:14px;"> <?php echo ("Qty"); ?></th>
    ...
    foreach ($purchase_order_items as $item) {
        ...
        <td style="width: 7%; border: 1px solid #fff; padding: 10px;"><?php echo ++$counter;  ?>
            ...
            <td style="width: 18%; border: 1px solid #fff; padding: 10px;"><?php echo $item->title; ?>
                <br />
                <span style="color: #888; font-size: 90%;"><?php echo nl2br($item->description); ?></span>
            </td>
            <td style="width: 12%; border: 1px solid #fff; padding: 10px;max-width: 10px;word-wrap: break-word;"><?php $category_name = $this->Product_categories_model->get_one($item->category);
             echo $category_name->title ? $category_name->title:"-"; ?>
                </td>
            <td style="width: 14%; border: 1px solid #fff; padding: 10px;max-width: 10px;word-wrap: break-word;"><?php

$make_name = $this->Manufacturer_model->get_one($item->make);
            ...
            <td style="width: 6%; border: 1px solid #fff; padding: 10px;max-width: 10px;word-wrap: break-word;"><?php echo $item->hsn_code; ?>
                ...
                <td style="width: 7%; border: 1px solid #fff; padding: 10px;"><?php echo $item->gst.'%'; ?>
                </td>
            ...
            <td style="text-align: right; width: 14%; border: 1px solid #fff;max-width:90px;word-wrap: break-word;padding: 10px;"> <?php echo to_currency($item->total, $item->currency_symbol); ?></td>
    ...
    <?php } ?>
    <tr>
        <td colspan="8" style="text-align: right;color:#181919;"><?php echo lang("sub_total"); ?></td>
        <td style="text-align: right; width: 14%; border: 1px solid #fff; background-color: #f4f4f4;max-width:90px;word-wrap: break-word;color:#181919;">
            <?php echo to_currency($purchase_order_total_summary->estimate_subtotal, $purchase_order_total_summary->currency_symbol); ?>
        </td>
         <!--td colspan="1" ></td-->
        <!--td style="text-align:right; width: 11%; border: 1px solid #fff; background-color: #f4f4f4;max-width:100px;word-wrap: break-word;color:#181919;">
            <?php echo to_currency($purchase_order_total_summary->estimate_tax_subtotal, $purchase_order_total_summary->currency_symbol); ?>
        </td-->
       <?php /* if($k>0){?> <td style="text-align: right; width: 5%; border: 1px solid #fff; background-color: #f4f4f4;"></td><?php }  */?>
        <!--td style="text-align: right; width: 14%; border: 1px solid #fff; background-color: #f4f4f4;max-width:100px;word-wrap: break-word;color:#181919;">
            <?php echo to_currency($purchase_order_total_summary->estimate_net_subtotal, $purchase_order_total_summary->currency_symbol); ?>
        </td-->
    </tr>
    <!--<?php
    ...
    <?php if($purchase_order_total_summary->freight_amount){?>
     <tr>
        <td colspan="8" style="text-align: right;color:#181919;"><?php echo lang("freight"); ?></td>
        <?php /* if($k>0){?> <td style="text-align: right; width: 5%; border: 1px solid #fff; background-color: #f4f4f4;"></td><?php } */?>
        <td style="text-align: right; width: 14%; border: 1px solid #fff; background-color: #f4f4f4;max-width:90px;word-wrap: break-word;color:#181919;">
            <?php echo to_currency($purchase_order_total_summary->freight_tax2, $purchase_order_total_summary->currency_symbol); ?>
        </td>
    </tr>
    <?php } ?>
...
if($company_gstin_number_first_two_digits !==$vendor_info->gstin_number_first_two_digits) {?>
        <tr>
            <td colspan="8" style="text-align: right;color:#181919;"><?php echo 'IGST OUTPUT'; ?></td>
            <?php /* if($k>0){?> <td style="text-align: right; width: 5%; border: 1px solid #fff; background-color: #f4f4f4;"></td><?php } */ ?>
            <td style="text-align: right; width: 14%; border: 1px solid #fff; background-color: #f4f4f4;max-width:90px;word-wrap: break-word;color:#181919;">
                <?php echo to_currency($purchase_order_total_summary->estimate_tax_subtotal+$purchase_order_total_summary->freight_tax3, $purchase_order_total_summary->currency_symbol); ?>
            </td>
        </tr>
    <?php } ?>
...
if($company_gstin_number_first_two_digits ==$vendor_info->gstin_number_first_two_digits) {?>
        <tr>
            <td colspan="8" style="text-align: right;color:#181919;"><?php echo 'CGST OUTPUT'; ?></td>
            <?php /* if($k>0){?> <td style="text-align: right; width: 5%; border: 1px solid #fff; background-color: #f4f4f4;"></td><?php } */?>
            <td style="text-align: right; width: 14%; border: 1px solid #fff; background-color: #f4f4f4;max-width:90px;word-wrap: break-word;color:#181919;">
        ...
        <tr>
            <td colspan="8" style="text-align: right;color:#181919;"><?php echo 'SGST OUTPUT'; ?></td>
            <?php /*if($k>0){?> <td style="text-align: right; width: 5%; border: 1px solid #fff; background-color: #f4f4f4;"></td><?php } */ ?>
...
<?php } ?>
   ...
   <?php } ?>
    ...
    <tr>
        <td colspan="8" style="text-align: right;color:#181919;"><?php echo lang("total"); ?></td>
        <?php /* if($k>0){?> <td style="text-align: right; width: 5%; border: 1px solid #fff; background-color: #f4f4f4;"></td><?php } */?>
        <td style="text-align: right; width: 14%; border: 1px solid #fff; background-color: #f4f4f4;max-width:90px;word-wrap: break-word;color:#181919;">
            <?php echo to_currency($purchase_order_total_summary->estimate_net_subtotal_default, $purchase_order_total_summary->currency_symbol); ?>
        </td>
    </tr>
    <?php $c= to_currency($purchase_order_total_summary->estimate_net_subtotal_default); $d=substr($c,-2); if($d>0){ ?>
    <tr>
        <td colspan="8" style="text-align: right;color:#181919;"><?php echo lang("round_off"); ?></td>
        <?php /*if($k>0){?> <td style="text-align: right; width: 5%; border: 1px solid #fff; background-color: #f4f4f4;"></td><?php } */?>
        <td style="text-align: right; width: 14%; border: 1px solid #fff; background-color: #f4f4f4;max-width:90px;word-wrap: break-word;color:#181919;">
            <?php $c= to_currency($purchase_order_total_summary->estimate_net_subtotal_default); $d=substr($c,-2); if($d>=50){
            $e=(100-$d);
            echo "(+)0.".$e;
            }elseif($d<50){
                echo "(-)0.".$d;
    ...
    <?php if ($purchase_order_total_summary->total_paid) { ?>     
        <tr>
            <td colspan="8" style="text-align: right;color:#181919;"><?php echo lang("paid"); ?></td>
    ...
    <tr>
        <td colspan="8" style="text-align: right;color:#181919;"><?php echo lang("balance_due"); ?></td>
        <?php /*if($k>0){?> <td style="text-align: right; width: 5%; border: 1px solid #fff; background-color: #f4f4f4;"></td><?php } */?>
...
<table style="width: 100%; color: #444;">            
    <tr style="font-weight: bold; background-color: <?php echo $color; ?>; color: #fff;  ">
    <th style="width: 7%; text-align: center; border-right: 1px solid #eee;"> <?php echo lang("s.no"); ?> </th>
        <th style="width: 20%; border-right: 1px solid #eee;"> <?php echo lang("model"); ?> </th>
        <th style="text-align: left;  width: 13%; border-right: 1px solid #eee;"> <?php echo lang("category"); ?></th>
 ...
 <th style="text-align: center;  width: 12%; border-right: 1px solid #eee;font-size:14px;"> <?php echo ("Qty"); ?></th>
        ...
        <!--th style="text-align: right;  width: 11%; border-right: 1px solid #eee;"> <?php echo lang("tax_amount"); ?></th-->
       <?php /*if($k>0){?> <th style="text-align: center;  width: 5%; border-right: 1px solid #eee;"> <?php echo ("Disc"); ?></th> <?php } */?>
        <th style="text-align: right;  width: 18%; border-right: 1px solid #eee;"> <?php echo lang("total"); ?></th>
    ...
    foreach ($purchase_order_items as $item) {
        ...
        <td style="width: 7%; border: 1px solid #fff; padding: 10px;"><?php echo ++$counter;  ?>
            ...
            <td style="width: 13%; border: 1px solid #fff; padding: 10px;max-width: 10px;word-wrap: break-word;"><?php $category_name = $this->Product_categories_model->get_one($item->category);
             echo $category_name->title ? $category_name->title:"-"; ?>
                </td>
            <td style="width: 15%; border: 1px solid #fff; padding: 10px;max-width: 10px;word-wrap: break-word;"><?php $make_name = $this->Manufacturer_model->get_one($item->make);
             echo $make_name->title ? $make_name->title:"-"; ?>
                </td>
            ...
            <td style="text-align: right; width: 15%; border: 1px solid #fff;max-width:85px;word-wrap: break-word;"> <?php echo to_currency($item->total/$item->quantity, $item->currency_symbol); ?></td>
            ...
            <?php /*if($k>0){?><td style="width: 5%; border: 1px solid #fff; padding: 10px;"><?php echo $item->discount_percentage.'%'; ?>
                ...
                <td style="text-align: right; width: 18%; border: 1px solid #fff;max-width:100px;word-wrap: break-word;"> <?php echo to_currency($item->net_total, $item->currency_symbol); ?></td>
        </tr>
    <?php } ?>
    <tr>
        <td colspan="6" style="text-align: right;color:#181919;"><?php echo lang("sub_total"); ?></td>
        <!--td style="text-align: right; width: 12%; border: 1px solid #fff; background-color: #f4f4f4;max-width:90px;word-wrap: break-word;color:#181919;">
            <?php echo to_currency($purchase_order_total_summary->estimate_subtotal, $purchase_order_total_summary->currency_symbol); ?>
        </td-->
         <td style="text-align: right; width: 18%; border: 1px solid #fff; background-color: #f4f4f4;max-width:100px;word-wrap: break-word;color:#181919;">
            <?php echo to_currency($purchase_order_total_summary->estimate_net_subtotal, $purchase_order_total_summary->currency_symbol); ?>
        </td>
    </tr>
    ...
    <?php if($purchase_order_total_summary->freight_amount){?>
     <tr>
        <td colspan="6" style="text-align: right;color:#181919;"><?php echo lang("freight"); ?></td>
        
        <td style="text-align: right; width: 18%; border: 1px solid #fff; background-color: #f4f4f4;max-width:90px;word-wrap: break-word;color:#181919;">
            <?php echo to_currency($purchase_order_total_summary->freight_tax2, $purchase_order_total_summary->currency_symbol); ?>
        </td>
    </tr>
    <?php } ?>
...
$company_setup_country = get_setting("company_setup_country");
if($company_setup_country ==$vendor_info->country) {?>  
<?php if($purchase_order_info->gst!=="0") { ?>
...
$company_gstin_number_first_two_digits= get_setting("company_gstin_number_first_two_digits");
if($company_gstin_number_first_two_digits !==$vendor_info->gstin_number_first_two_digits) {?>
<?php if($purchase_order_total_summary->freight_tax3) { ?>
<tr>
        <td colspan="6" style="text-align: right;color:#181919;"><?php echo lang("igst_output"); ?></td>
        
        <td style="text-align: right; width: 18%; border: 1px solid #fff; background-color: #f4f4f4;max-width:90px;word-wrap: break-word;color:#181919;">
            <?php echo to_currency($purchase_order_total_summary->freight_tax3, $purchase_order_total_summary->currency_symbol); ?>
        </td>
    </tr>
       <?php } ?>
...
<?php if($purchase_order_total_summary->freight_tax3) { ?>
<tr>
        <td colspan="6" style="text-align: right;color:#181919;"><?php echo lang("cgst_output"); ?></td>
        
        <td style="text-align: right; width: 18%; border: 1px solid #fff; background-color: #f4f4f4;max-width:90px;word-wrap: break-word;color:#181919;">
            <?php echo to_currency($purchase_order_total_summary->freight_tax3/2, $purchase_order_total_summary->currency_symbol ); ?>
        </td>
    </tr>
    <tr>
      
        <td colspan="6" style="text-align: right;color:#181919;"><?php echo lang("sgst_output"); ?></td>
...
<?php } ?>
    ...
    <tr>
        <td colspan="6" style="text-align: right;color:#181919;"><?php echo lang("total"); ?></td>
    ...
    <?php $c= to_currency($purchase_order_total_summary->estimate_net_subtotal_default); $d=substr($c,-2); if($d>0){ ?>
    <tr>
        <td colspan="6" style="text-align: right;color:#181919;"><?php echo lang("round_off"); ?></td>
    ...
    <?php if ($purchase_order_total_summary->total_paid) { ?>     
        <tr>
            <td colspan="6" style="text-align: right;color:#181919;"><?php echo lang("paid"); ?></td>
    ...
    <tr>
        <td colspan="6" style="text-align: right;color:#181919;"><?php echo lang("balance_due"); ?></td>
        <td style="text-align: right; width: 18%; background-color: <?php echo $color; ?>; color: #fff;max-width:90px;word-wrap: break-word;">
            <?php echo to_currency($purchase_order_total_summary->balance_due, $purchase_order_total_summary->currency_symbol); ?>
        </td>
    </tr>
</table>
...
<table style="width: 99%; color: #444;line-height: 15px">
 ...
 if($purchase_order_total_summary->balance_due){

$numbers = $purchase_order_total_summary->balance_due;
