                ...
                <?php if ($this->login_user->is_admin || $reply->created_by == $this->login_user->id) { ?>
                    <span class="pull-right dropdown reply-dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li role="presentation"><?php echo ajax_anchor(get_uri("messages/group_delete_comment/$reply->id"), "<i class='fa fa-times'></i> " . lang('delete'), array("class" => "", "title" => lang('delete'), "data-fade-out-on-success" => "#prject-comment-reply-container-$reply->id")); ?> </li>
                        </ul>
                    </span>
                <?php } ?>
            ...
            <!-- <div class="comment-image-box clearfix"> -->
                ...
                if ($reply->files) {
                    ...
                    if ($total_files) {
                        ...
                        echo anchor(get_uri("messages/group_download_comment_files/" . $reply->id), $download_caption, array("class" => "pull-right", "title" => $download_caption));
                    }
                }
                ?>
           <!--  </div> -->
