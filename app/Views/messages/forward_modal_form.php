<div id="new-message-dropzone" class="post-dropzone">
    <?php echo form_open(get_uri("messages/forward_send_message"), array("id" => "message-form", "class" => "general-form", "role" => "form")); ?>
    <div class="modal-body clearfix">
         <input type="hidden" name="forward_files" value="<?php echo $model_info->message_id; ?>" />
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                if (isset($message_user_info)) {
                    ...
                    ?>
                    <input type="hidden" name="to_user_id" value="<?php echo $this->load->view("includes/file_list", array("files" => $model_info->files)); ?>" />
                    <?php
                } else {
        ...
        <div class="form-group">
            <div class="col-md-12">
                <?php
                $this->load->view("messages/file_list", array("files" => $model_info->files));
                ?>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-12">
                <?php $this->load->view("includes/dropzone_preview",array("files" => $model_info->files)); ?> 
            </div>
        </div>
