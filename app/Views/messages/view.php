        ...
        <div class="media-body w100p">
            <div class="media-heading clearfix">
                ...
                <span class="pull-right dropdown" style="position: absolute; right: 30px; margin-top: 15px;">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li role="presentation"><?php echo ajax_anchor(get_uri("messages/delete_my_messages/$message_info->id"), "<i class='fa fa-times'></i> " . lang('delete_all'), array("class" => "", "title" => lang('delete_all'), "data-fade-out-on-success" => ".message-container-$message_info->id")); ?> </li>
                        <li role="presentation"> <?php echo modal_anchor(get_uri("messages/forward_modal_form/"), "<i class='fa fa-forward'></i> " . lang('forward'), array("title" => lang("forward"), "data-post-message_info_id" => $message_info->id)); ?> </li>
                    </ul>
                </span>
            </div>
            ...
            <p>
                ...
                if ($total_files) {
                    ...
                    echo anchor(get_uri("messages/download_message_files/" . $message_info->id), $download_caption, array("class" => "", "title" => $download_caption));
                }
                ?>
            </p>
