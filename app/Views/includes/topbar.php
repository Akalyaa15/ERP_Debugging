...
<?php  echo "<link id='custom-theme-color' class='custom-theme-color' rel='stylesheet'  type='text/css' href='" . base_url($uri) .'assets/css/color/'.$this->login_user->theme_color."' />"; ?>
