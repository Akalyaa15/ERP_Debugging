<?php echo form_open(get_uri("partner_groups/save"), array("id" => "groups-form", "class" => "general-form", "role" => "form")); ?>
    ...
    $(document).ready(function() {
        $("#groups-form").appForm({
            onSuccess: function(result) {
                $("#partner-groups-table").appTable({newData: result.data, dataId: result.id});
            }
        });
        $("#title").focus();
    });
