<?php echo form_open(get_uri("deductions/save"), array("id" => "deductions-form", "class" => "general-form", "role" => "form")); ?>
    ...
    $(document).ready(function() {
        $("#deductions-form").appForm({
            onSuccess: function(result) {
                $("#deductions-table").appTable({newData: result.data, dataId: result.id});
            }
        });
        $("#title").focus();
    });
