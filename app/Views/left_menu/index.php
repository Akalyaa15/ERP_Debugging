                ...
                <div class="page-title clearfix">
                    <h4>
                        ...
                        if ($type == "client_default") {
                            ...
                            echo lang('left_menu_for_vendor');
                        } else {
                            echo lang('left_menu');
                        }
                        ?>
                    ...
                    <div class="title-button-group">
                        ...
                        }else if ($type == "vendor_default" && get_setting("default_vendor_left_menu")) {
                            echo anchor(get_uri("left_menus/restore/vendor_default"), "<span class='fa fa-refresh'></span> " . lang("restore_to_default"), array("class" => "btn btn-danger"));
                ...
                <div class="panel-body">
                    <div class="text-off pb15">
                        ...
                        if ($type == "client_default") {
                            ...
                            echo lang('left_menu_setting_help_message_for_vendor');
                        }else {
