...
<table style="color: #444; width: 100%;">
      <!-- <tr><td><?php if ($job_info->date_of_hire) { ?>
                <br /><?php echo lang("date_of_joining") . ": " . $data_of_joining; ?>
            <?php }  ?>
          <br /><?php  echo "Currency Paid In " . ": " .$currency_paid_in;?>
        
                <br /><?php echo "Payment Mode" . ": " . "Bank"; ?>
            
                <br /><?php echo "Bank Name" . ": " .  $bank_name; ?>
            
                <br /><?php echo "Account No" . ": " .$account_number; ?>
            
                <br /><?php echo "IFSC COde" . ": " . $ifsc_code; ?>
            
                <br /><?php echo "MICR Code" . ": " . $micr_code; ?>
           
            <br /><?php echo lang("swift_code") . ": " .$swift_code ; ?>
            <br /><?php echo "IBAN Code" . ": " .$iban_code ; ?>
