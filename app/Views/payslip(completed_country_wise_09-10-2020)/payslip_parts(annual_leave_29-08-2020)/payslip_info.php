<span style="font-size:20px; font-weight: bold;background-color: <?php echo $color; ?>; color: #fff;">&nbsp;<?php echo /*get_payslip_id($payslip_info->id)*/$payslip_info->payslip_no?$payslip_info->payslip_no:get_payslip_id($payslip_info->id); ?>&nbsp;</span>
