<span style="font-size:20px; font-weight: bold;background-color: <?php echo $color; ?>; color: #fff;">&nbsp;<?php echo /*get_voucher_id($estimate_info->id)*/$estimate_info->voucher_no?$estimate_info->voucher_no:get_voucher_id($estimate_info->id); ?>&nbsp;</span>
...
?>
<span><?php echo lang("voucher_date") . ": " . format_to_date($estimate_info->estimate_date, false); ?></span><br />
