<?php echo form_open(get_uri("unit_type/save"), array("id" => "unit_type-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#unit_type-form").appForm({
            onSuccess: function(result) {
                $("#unit_type-table").appTable({newData: result.data, dataId: result.id});
            }
        });
        $("#title").focus();
    });
