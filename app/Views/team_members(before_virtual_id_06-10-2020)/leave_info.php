                ...
                loadMembersLeavesTable = function(selector, dateRange) {
                    $(selector).appTable({
                        ...
                        dateRangeType: dateRange,
                                    radioButtons: [{text: '<?php echo lang("my_leave") ?>', name: "applicant_id", value: '<?php echo $applicant_id; ?>', isChecked: true},{text: '<?php echo lang("others") ?>', name: "applicant_id", value:'line_manager', isChecked: false} ],
