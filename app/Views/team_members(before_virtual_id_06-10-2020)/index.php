<?php/*  $timeline_file_path = get_setting("timeline_file_path");
        echo $timeline_file_path;*/?><div id="page-content" class="p20 clearfix">
    ...
    $(document).ready(function () {
        ...
        $("#team_member-table").appTable({
            ...
            columns: [
                ...
                {visible: visibleContact,title: "<?php echo lang("role") ?>", "class": "w15p"},
                {visible: visibleContact, title: "<?php echo lang("work_mode") ?>", "class": "w15p"},
