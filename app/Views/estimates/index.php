...
<script type="text/javascript">
    loadEstimatesTable = function (selector, dateRange) {
        $(selector).appTable({
            ...
            filterDropdown: [{name: "status", class: "w150", options: <?php $this->load->view("estimates/estimate_statuses_dropdown"); ?>},{name: "payment_status", class: "w150", options: <?php  $this->load->view("estimates/estimate_payment_statuses_dropdown"); ?>}
            
            ],
            columns: [
                {title: "<?php echo lang("id") ?> ", "class": "w10p"},
                {title: "<?php echo lang("estimate_no") ?> ", "class": "w15p"},
...
<?php echo $custom_field_headers; ?>,
            ...
            summation: [{column: 5, dataType: 'currency', currencySymbol: AppHelper.settings.currencySymbol},{column: 6, dataType: 'currency', currencySymbol: AppHelper.settings.currencySymbol},{column: 7, dataType: 'currency', currencySymbol: AppHelper.settings.currencySymbol}]
        });
    };
