...
class Vat_types extends BaseController
{
    ...
    public function __construct()
    {
        ...
        // Load the model via property injection
    ...
    public function save()
    {
        ...
        if ($save_id) {
            return $this->respond([
                ...
                'id' => $save_id,
                'message' => lang('record_saved') // Assuming you have lang() function defined
            ]);
        } else {
        ...
        if ($this->request->getPost('undo')) {
            if ($this->vattypesmodel->delete($id, true)) {
                return $this->respond([
                    ...
                    'message' => lang('record_undone') // Assuming you have lang() function defined
                ]);
            } else {
                return $this->fail(lang('error_occurred'));
            }
            ...
            if ($this->vattypesmodel->delete($id)) {
                return $this->respond([
                    'success' => true,
                    'message' => lang('record_deleted') // Assuming you have lang() function defined
                ]);
            } else {
    ...
    private function _make_row($data)
    {
        return [
            ...
            lang($data->status), // Assuming you have lang() function defined
            modal_anchor(get_uri('vat_types/modal_form'), "<i class='fa fa-pencil'></i>", [
                'class' => 'edit',
                'title' => lang('edit_vat_type'), // Assuming you have lang() function defined
                'data-post-id' => $data->id
            ]) .
            js_anchor("<i class='fa fa-times fa-fw'></i>", [
                'title' => lang('delete_vat_type'), // Assuming you have lang() function defined
                'class' => 'delete',
                'data-id' => $data->id,
